...
const ProductDetails = () => {
    ...
    return (
        <div className='bg-white p-10 w-full mx-auto my-6 rounded-2xl lg:w-4/5'>
           <img className='w-full mx-auto border-double border-b-4 shadow-md shadow-slate-900 rounded-2xl border-slate-900 h-64 lg:h-96 bg-slate-100' src={img} alt="" />
